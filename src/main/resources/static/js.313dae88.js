  ...
  _createClass(Grid, [{
    ...
    value: function getCellsInRange(firstLetter, currentLetter) {
      ...
      if (firstLetter.y === currentLetter.y) {
        for (var i = firstLetter.x; i <= currentLetter.x; i++) {
          cellInRange.push(this.gridArea.querySelector("td[data-x=\"".concat(i, "\"][data-y=\"").concat(currentLetter.y, "\"]")));
        }
      } else if (firstLetter.x === currentLetter.x) {
        for (var _i = firstLetter.y; _i <= currentLetter.y; _i++) {
          cellInRange.push(this.gridArea.querySelector("td[data-x=\"".concat(currentLetter.x, "\"][data-y=\"").concat(_i, "\"]")));
        }
        ...
        for (var _i2 = 0; _i2 <= delta; _i2++) {
          cellInRange.push(this.gridArea.querySelector("td[data-x=\"".concat(firstLetter.x + _i2, "\"][data-y=\"").concat(firstLetter.y + _i2, "\"]")));
        }
      }
    ...
    value: function renderGrid(gridSize, wordGrid) {
      ...
      tbl.addEventListener("mouseup", function (event) {
        _this.woldSelectMode = false;

        var selectedWords = _this.selectedItems.reduce(function (word, cell) {
          return word += cell.getAttribute("data-letter");
        }, '');

        var reverseSelectedWord = selectedWords.split("").reverse().join("");

        if (_this.words.indexOf(selectedWords) !== -1) {
          _this.foundWord.push(selectedWords);
        } else if (_this.words.indexOf(reverseSelectedWord) !== -1) {
          _this.foundWord.push(reverseSelectedWord);
        } else {
...
var wordSubmitBtn = document.querySelector(".submit-word");
wordSubmitBtn.addEventListener("click", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
...
//# sourceMappingURL=/js.313dae88.js.map